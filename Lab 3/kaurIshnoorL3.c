...
int main()
{
    ...
    timeElapsed += ((double)(end - begin) / CLOCKS_PER_SEC);
    printf("Time elpased for recursive sum is %lf seconds \n", timeElapsed);
    ...
    timeElapsed += ((double)(end - begin) / CLOCKS_PER_SEC);
    printf("Time elpased for iterative Fibonacci is %lf seconds \n", timeElapsed);
    ...
    timeElapsed += ((double)(end - begin) / CLOCKS_PER_SEC);
    printf("Time elpased for recursive Fibonacci is %lf seconds \n", timeElapsed);
